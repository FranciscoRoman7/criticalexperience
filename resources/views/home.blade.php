    ...
    <div id="content-container">
        <div id="page-content-wrapper">
            <div class="container mt-4">
                ...
                <hr>
                <p class="lead text-center mb-0">Esta aplicación de gestión de juegos de rol ofrece herramientas poderosas para administrar diferentes aspectos dentro de tu entorno.</p>
               
                <!-- Cards para cada apartado correspondiendo a los elementos del Navbar -->
                <div class="row">
                @if($isAdmin)
                    <div class="col-lg-4 col-md-4 mb-4" id="Usuarios">
